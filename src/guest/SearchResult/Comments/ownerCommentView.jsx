...
function OwnerCommentView(props) {
    const { comment } = props;
    ...
    return (
        <React.Fragment>
            <div className="card mb-2">
                <div className="row no-gutters">
                    ...
                    <div className="col">
                        <div className="card-block px-2 pt-2 pb-0">
                            ...
                            <p className="card-text">{allBodyIsVisible ? comment.body : truncateString(comment.body)}
                ...
                <div className="card-footer w-100 text-muted p-1 bg-secondary text-white" >
                <small>  By a {comment.sender}, at {formattedDate(comment.createdAt)}</small>                </div>
            </div>            
        </React.Fragment>
    )
}
...
export default OwnerCommentView;
