...
function Login({ history, location, isMobile }) {
  ...
  return (
    <div className="card  bg-light mb-3 card-two col-xl-8 col-md-10 shadow p-0">
      <Formik
            ...
            <div className={"card-body "+(isMobile?"p-1":"p-3")}>
              ...
              <div className="input-group">
                  <div className="input-group-prepend">
                    <span className="input-group-text">{t("login.username")}</span>
                  </div>
                <Field
                  name="username"
                  type="text"
              ...
              <div className="input-group">
                  <div className="input-group-prepend">
                    <span className="input-group-text">{t("login.password")}</span>
                  </div>
                <Field
                  name="password"
                  type="password"
              ...
              <div className="form-row">
                <div className="form-group col">
                  ...
                  <Link to="account/register" className="btn btn-link-violet  ">
                    {t("login.register-btn")}
                  </Link>
                </div>
                <div className="form-group col text-right">
                  <Link to="forgot-password" className="btn btn-link-violet pr-0">
