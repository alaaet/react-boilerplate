...
function Policy() {
    return (
        <div className="container">
            <h3>IDSHEET Privacy Policy</h3>

This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.clavitag,com (the “Site”).
...
<h3>CONTACT US</h3>
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at admin@clavitag.com or by mail using the details provided below:

  calle del porvenir 41 pb, Zaragoza, AR, 50006, Spain
        </div>
    )
}
